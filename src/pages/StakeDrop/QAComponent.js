...
export default function QAComponent({ Quiz, closeModal, TimeLeftQuiz }) {
  // answer
      ...
      fetch(`https://cosmos-stakedrop.assetmantle.one/qna/${address}`)
        ...
        .then((data) => {
          if (data.success === true) {
            ...
            setSubmit(
              data.qaData[0].correct.toString() === "true" &&
                data.qaData[1].correct.toString() === "true" &&
                data.qaData[2].correct.toString() === "true"
                ? 3
                : data.qaData[0].correct.toString() === "false" &&
                  data.qaData[1].correct.toString() === "true" &&
                  data.qaData[2].correct.toString() === "true"
                ? 2
                : data.qaData[0].correct.toString() === "true" &&
                  data.qaData[1].correct.toString() === "false" &&
                  data.qaData[2].correct.toString() === "true"
                ? 2
                : data.qaData[0].correct.toString() === "true" &&
                  data.qaData[1].correct.toString() === "true" &&
                  data.qaData[2].correct.toString() === "false"
                ? 2
                : data.qaData[0].correct.toString() === "false" &&
                  data.qaData[1].correct.toString() === "false" &&
                  data.qaData[2].correct.toString() === "true"
        ...
        <div className="modal_container">
          ...
          {SubmitStatus === true ? (
            <div className="Success_qas">
              ...
              <br />
              <br />
              <h3>You answered {Submit} out of 3 questions correctly.</h3>
            </div>
          ) : (
            <>
              ...
              <div className="section_questions__qBox_footer">
                <div className="section_questions__qBox_footer__element">
                  <button
                    ...
                    onClick={() =>
                      setQuestionShow(questionShow !== 0 ? questionShow - 1 : 0)
                    }
                ...
                <div className="section_questions__qBox_footer__element">
                  <button
                    ...
                    onClick={() =>
                      setQuestionShow(questionShow !== 2 ? questionShow + 1 : 2)
                    }
