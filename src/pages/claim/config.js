...
const mainNetChainID = process.env.REACT_APP_mainNetChainID;
const chainName = process.env.REACT_APP_chainName;
const coinName = process.env.REACT_APP_coinName;
const coinDenom = process.env.REACT_APP_coinDenom;
const addressPrefix = process.env.REACT_APP_addressPrefix;
const restAPI = process.env.REACT_APP_restAPI;
const tendermintRPC = process.env.REACT_APP_tendermintRPC;
