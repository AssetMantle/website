  ...
  const stones = (ind) => {
    return {
      ...
      "@keyframes bounceRotate": {
        "0%": {
          transform: `translateY(-${10 + ind}px) rotate(0deg)`,
        },
        "25%": {
          transform: `translateY(${10 + ind}px) rotate(90deg)`,
        },
        "50%": {
          transform: `translateY(-${10 + ind}px) rotate(180deg)`,
        },
        "75%": {
          transform: `translateY(${10 + ind}px) rotate(270deg)`,
        },
        "100%": {
          transform: `translateY(-${10 + ind}px) rotate(360deg)`,
        },
      },
      animation: `bounceRotate infinite ${8000 + ind * 100}ms linear both`,
      "@keyframes ZoomInOut": {
        "0%": {
          transform: "scale(0.9)",
        },
